...
- [The massage recommender tokenized program](#massage-recommender-R)

- [The Massage Recommender Program](#the-massage-recommender-program)

- [Version 1 finished program](#version-1)

- [Version 2 finished program](#version-2)

- [Keras DNNs as a superb Predictor Model](#tensorFlow-keras-for-deep-neural-network-predictions)
]
...
[Results Random Forest](#results-random-forest)
[Results Gradient Boosted Trees](#results-gradient-boosted-trees)
...
Lets look at the table of health and wellness modalities based on the cleaned up reviews from a social media site. I took only the columns I might be interested in and saved it as 'userReviewBusinessTypeRatig.csv'. We will need to tokenize the words and put them into the same format that will run predictions on the ratings based on the tokenized reviews. 
